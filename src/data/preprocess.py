...
def preprocess_and_save(
    ...
    print("  Saved: train_X.parquet, train_y.parquet, test_X.parquet, test_y.parquet")
...
Examples:
    ...
    parser.add_argument(
        "--version", "-v", type=str, help="Preprocessing version (e.g., v1_median, v2_knn)"
    )
    parser.add_argument(
        "--input",
        "-i",
    ...
    parser.add_argument(
        "--output", "-o", type=str, help="Output directory (default: data/processed/{version})"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--list", "-l", action="store_true", help="List available preprocessing strategies"
    )
